...
public class ClientApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    while (true) {
      ...
      int slashPos = input.indexOf("/"); // 슬래시의 위치 리턴
      String serverAddress = input.substring(0, slashPos); // 처음부터 슬래시 전까지
      String queryString = input.substring(slashPos + 1); // 처음부터 끝까지, 두번째 인수를 주지 않으면
