...
public class ContactController {
  ...
  public ContactController() throws Exception {
    ...
    // 주 작업 객체
    DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream("contacts.CSV")));
  ...
  public Object save() throws Exception {
    DataOutputStream out = new DataOutputStream(new BufferedOutputStream(new FileOutputStream("contacts.CSV")));
