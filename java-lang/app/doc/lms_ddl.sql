...
CREATE TABLE lms_tchr (
	...
	hr_pay INTEGER NOT NULL COMMENT '고형형태번호', -- 고형형태번호
	COL7   INTEGER NULL     DEFAULT 0 COMMENT '시급' -- 시급
)
COMMENT '강사';
...
CREATE TABLE lms_work_type (
	wtno  INTEGER     NOT NULL COMMENT '고형형태번호', -- 고형형태번호
...
ALTER TABLE lms_work_type
	MODIFY COLUMN wtno INTEGER NOT NULL AUTO_INCREMENT COMMENT '고형형태번호';
