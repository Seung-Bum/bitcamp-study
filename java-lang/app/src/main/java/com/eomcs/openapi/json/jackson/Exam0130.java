...
public class Exam0130 {
  public static void main(String[] args) throws Exception {
    ...
    // 1) JSON 문자열 준비
    String jsonStr = "{\"no\":100,\"name\":\"홍길동\",\"email\":\"hong@test.com\",\"password\":\"1111\",\"photo\":\"hong.gif\",\"tel\":\"010-2222-1111\",\"registeredDate\":1642991116921}";
    ...
    Board b = mapper.readValue(jsonStr, Board.class); //.class 클래스 정보를 갖고있음
